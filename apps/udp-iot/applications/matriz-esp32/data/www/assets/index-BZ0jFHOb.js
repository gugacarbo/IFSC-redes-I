...
var l = o((e) => {
	...
	h = o((e) => {
		...
		function ve(e) {
			M.current === e && (A(fe), A(M)),
				me.current === e && (A(me), (Qf._currentValue = le));
		}
		var ye, be;
		function xe(e) {
			if (ye === void 0)
...
` +
		...
		function ot(e, t) {
			var n = t & -t;
			return (
				(n = n & 42 ? 1 : st(n)), (n & (e.suspendedLanes | t)) === 0 ? n : 0
			);
		}
		function st(e) {
			switch (e) {
		...
		var dt = Math.random().toString(36).slice(2),
			N = `__reactFiber$${dt}`,
			ft = `__reactProps$${dt}`,
			pt = `__reactContainer$${dt}`,
			mt = `__reactEvents$${dt}`,
			ht = `__reactListeners$${dt}`,
			gt = `__reactHandles$${dt}`,
			_t = `__reactResources$${dt}`,
			vt = `__reactMarker$${dt}`;
		function yt(e) {
		...
		var Ht = /[\n"\\]/g;
		function Ut(e) {
			return e.replace(Ht, (e) => `\\${e.charCodeAt(0).toString(16)} `);
		}
		...
		function Jt(e, t, n) {
			if (t != null && ((t = ``), t !== e.value && (e.value = t), n == null)) {
				e.defaultValue !== t && (e.defaultValue = t);
				return;
			}
			e.defaultValue = n == null ? `` : ``;
		}
		function Yt(e, t, n, r) {
			if (t == null) {
				if (r != null) {
					...
					!Object.hasOwn(n, r) ||
						...
						(r.indexOf(`--`) === 0
							...
							: r === `float`
								...
								: (e[r] = ``));
				for (var a in t)
					(r = t[a]), Object.hasOwn(t, a) && n[a] !== r && Qt(e, a, r);
			} else for (var o in t) Object.hasOwn(t, o) && Qt(e, o, t[o]);
		}
		function en(e) {
				...
				switch (((e = t.stateNode), t.type)) {
					case `input`:
						if (
							...
							for (
								n = n.querySelectorAll(`input[name="${Ut(``)}"][type="radio"]`),
									t = 0;
								t < n.length;
								t++
							) {
				...
				movementX: (e) =>
					`movementX` in e
						...
						: (e !== jn &&
								...
								(jn = e)),
							kn),
				movementY: (e) => (`movementY` in e ? e.movementY : An),
			}),
			Nn = wn(Mn),
		...
		var Wn = wn(
				h({}, Dn, {
					...
					locale: 0,
					getModifierState: Un,
					charCode: (e) => (e.type === `keypress` ? xn(e) : 0),
					keyCode: (e) =>
		...
		function br(e, t, n) {
			e === `focusin`
				? (vr(), (ur = t), (dr = n), ur.attachEvent(`onpropertychange`, yr))
				: e === `focusout` && vr();
		}
		function xr(e) {
		...
		function Tr(e, t) {
			...
			for (r = 0; r < n.length; r++) {
				var i = n[r];
				if (!Ee.call(t, i) || !I(e[i], t[i])) return !1;
			}
			return !0;
		}
		function Er(e) {
		...
		var jr = mn && `documentMode` in document && 11 >= document.documentMode,
			L = null,
			Mr = null,
			Nr = null,
			Pr = !1;
		function Fr(e, t, n) {
			...
			Pr ||
				...
				`selectionStart` in r && Ar(r)
					...
					: ((r = (r.ownerDocument?.defaultView || window).getSelection()),
						(r = {
		...
		function Br(e) {
			...
			var t = Lr[e],
				n;
			for (n in t) if (Object.hasOwn(t, n) && n in zr) return (Rr[e] = t[n]);
			return e;
		}
		...
		function fi(e, t, n, r, a, o) {
			...
			if (((r = e), typeof e === `function`)) li(e) && (s = 1);
				...
				a: switch (e) {
					case ne:
						return (
							(e = ci(31, n, t, a)), (e.elementType = ne), (e.lanes = o), e
						);
					case y:
						return pi(n.children, a, o, t);
					case b:
						(s = 8), (a |= 24);
						break;
					case x:
						return (
							(e = ci(12, n, t, a | 2)), (e.elementType = x), (e.lanes = o), e
						);
					case T:
						return (e = ci(13, n, t, a)), (e.elementType = T), (e.lanes = o), e;
					case ee:
						return (
							(e = ci(19, n, t, a)), (e.elementType = ee), (e.lanes = o), e
						);
					default:
		...
		function vi(e, t) {
			if (typeof e === `object` && e) {
				var n = _i.get(e);
				return n === void 0
					? ((t = { value: e, source: t, stack: Te(t) }), _i.set(e, t), t)
					: n;
			}
			...
			for (var a = t, o = !1; a !== null; ) {
				...
				if (a.tag === 10) {
					...
					if (((s = s.memoizedProps), s !== null)) {
						var c = a.type;
						I(a.pendingProps.value, s.value) ||
							(e === null ? (e = [c]) : e.push(c));
					}
		...
		function Ia(e) {
			...
			function l(e, t, n, r) {
				...
				return i === y
					...
					: t !== null &&
						...
						: ((t = fi(n.type, n.key, n.props, null, e.mode, r)),
							Pa(t, n),
							(t.return = e),
							t);
			}
			...
			function d(e, t, n, r, i) {
				return t === null || t.tag !== 7
					? ((t = pi(n, e.mode, r, i)), (t.return = e), t)
					: ((t = a(t, n)), (t.return = e), t);
			}
			function f(e, t, n) {
				if (
					...
					return (t = mi(``, e.mode, n)), (t.return = e), t;
				if (typeof t === `object` && t) {
					switch (t.$$typeof) {
						case _:
							return (
					...
					if (ce(t) || ae(t))
						return (t = pi(t, e.mode, n, null)), (t.return = e), t;
				...
				for (d = r(d); h < s.length; h++)
					(g = m(d, i, h, s[h], c)),
						g !== null &&
							...
							(u = g));
				return e && d.forEach((e) => t(i, e)), B && Oi(i, h), l;
			}
			function g(a, s, c, l) {
				...
				for (h = r(h); !v.done; g++, v = c.next())
					(v = m(h, a, g, v.value, l)),
						v !== null &&
							...
							d === null ? (u = v) : (d.sibling = v),
							(d = v));
				return e && h.forEach((e) => t(a, e)), B && Oi(a, g), u;
			}
			function b(e, r, o, c) {
				if (
					(typeof o === `object` &&
					...
					switch (o.$$typeof) {
						case _:
							a: {
								...
								o.type === y
									? ((c = pi(o.props.children, e.mode, c, o.key)),
										(c.return = e),
										(e = c))
		...
		function So(e, t, n, r, i, a) {
			return (
				...
				(t.updateQueue = null),
				(t.lanes = 0),
				(D.H = e === null || e.memoizedState === null ? zs : Bs),
				(go = !1),
				(a = n(r, i)),
				(go = !1),
				ho && (a = wo(t, n, r, i)),
		...
		function Mo(e) {
			...
			return (
				...
				(po === null ? t.memoizedState : po.next) === null &&
					((t = t.alternate),
					(D.H = t === null || t.memoizedState === null ? zs : Bs)),
				e
			);
		}
		function No(e) {
		...
		function Lo(e, t, n) {
			...
			if (((o = e.baseState), a === null)) e.memoizedState = o;
				...
				if (
					(l === null ? (s = o) : (l.next = c),
					!I(o, e.memoizedState) && ((rc = !0), d && ((n = fa), n !== null)))
				)
					throw n;
				(e.memoizedState = o),
					(e.baseState = s),
		...
		function Ss(e, t, n, r, i) {
			...
			try {
				...
				Ns(e, t, { then: () => {}, status: `rejected`, reason: n }, pu());
			} finally {
				(O.p = a),
		...
		function ws(e, t, n, r) {
			...
			var a = Ts(e).queue;
			Ss(e, a, t, le, n === null ? Cs : () => (Es(e), n(r)));
		}
		function Ts(e) {
			var t = e.memoizedState;
			if (t !== null) return t;
		...
		function js(e, t, n) {
			...
			(n = {
				...
				Fs(e)
					? Is(t, n)
					: ((n = ni(e, t, n, r)), n !== null && (hu(n, e, r), Ls(n, t, r)));
		}
		function Ms(e, t, n) {
			Ns(e, t, n, pu());
		}
				...
				if (
					...
					try {
						var o = t.lastRenderedState,
							s = a(o, n);
						if (((i.hasEagerState = !0), (i.eagerState = s), I(s, o)))
		...
		var zs = {
				...
				use: No,
				useCallback: (e, t) => (
					(ko().memoizedState = [e, t === void 0 ? null : t]), e
				),
				useContext: ea,
				useEffect: ls,
				...
				useLayoutEffect: (e, t) => ss(4194308, 4, e, t),
				...
				useDebugValue: _s,
				useDeferredValue: (e, t) => bs(ko(), e, t),
				useTransition: () => {
					var e = Go(!1);
					return (
				...
				useMemoCache: Po,
				useCacheRefresh: () => (ko().memoizedState = As.bind(null, V)),
				useEffectEvent: (e) => {
					var t = ko(),
						n = { impl: e };
					return (
			...
			Bs = {
				...
				useState: () => Io(Fo),
				useDebugValue: _s,
				useDeferredValue: (e, t) => xs(Ao(), H.memoizedState, e, t),
				useTransition: () => {
					var e = Io(Fo)[0],
						t = Ao().memoizedState;
		...
		function tc(e, t, n, r, a) {
			...
			if (B)
				return (
					(t = no.current),
					t === null
						? (r !== Ii && ((t = Error(i(423), { cause: r })), Ui(vi(t, n))),
						...
						: (!(t.flags & 65536) && (t.flags |= 256),
							(t.flags |= 65536),
							(t.lanes = a),
							r !== Ii && ((e = Error(i(422), { cause: r })), Ui(vi(e, n)))),
					!1
				);
		...
		function Sc(e, t, n) {
			...
			if (l !== null && ((c = l.dehydrated), c !== null)) {
				if (o)
					...
					if (((s = c.nextSibling?.dataset), s)) var u = s.dgst;
					(s = u),
						(r = Error(i(419))),
						(r.stack = ``),
						(r.digest = s),
		...
		function kc(e, t, n) {
			...
			if (t.child !== null) {
				for (
					...
					(e = e.sibling),
						(n = n.sibling = ui(e, e.pendingProps)),
						(n.return = t);
				n.sibling = null;
			}
			return t.child;
			...
			switch (((t.lanes = 0), t.tag)) {
				case 16:
					a: {
						var r = t.pendingProps;
						if (
							((e = Da(t.elementType)), (t.type = e), typeof e === `function`)
						)
							li(e)
					...
					if (e && t.stateNode != null) e.memoizedProps !== r && Nc(t);
						...
						if (((e = pe.current), Bi(t))) {
							...
							(e[N] = t),
								...
								e || Li(t, !0);
						} else (e = Bd(e).createTextNode(r)), (e[N] = t), (t.stateNode = e);
					}
					return W(t), null;
				case 31:
		...
		var Ll = {
				...
				cacheSignal: () => ea(oa).controller.signal,
			},
			...
			fu = null;
		function pu() {
			return K & 2 && Y !== 0 ? Y & -Y : D.T === null ? lt() : dd();
		}
		function mu() {
			if (Jl === 0)
				if (!(Y & 536870912) || B) {
		...
		function qu(e, t) {
			t === 0 && (t = et()), (e = ri(e, t)), e !== null && (nt(e, t), rd(e));
		}
		function Ju(e) {
			var t = e.memoizedState,
				n = 0;
		...
		R(Vr, `onAnimationEnd`),
			R(Hr, `onAnimationIteration`),
			R(Ur, `onAnimationStart`),
			R(`dblclick`, `onDoubleClick`),
			R(`focusin`, `onFocus`),
			R(`focusout`, `onBlur`),
			R(Wr, `onTransitionRun`),
			R(Gr, `onTransitionStart`),
			R(Kr, `onTransitionCancel`),
			R(qr, `onTransitionEnd`),
...
`,
		...
		function Nd(e, t, n, r, a, o) {
			switch (n) {
				...
				case `children`:
					typeof r === `string`
						? Xt(e, r)
						: (typeof r === `number` || typeof r === `bigint`) && Xt(e, ``);
					break;
				case `onScroll`:
					r != null && Q(`scroll`, e);
					break;
		...
		function $f(e, _t, _n, r, i, a, o, _s, c) {
			(this.tag = 1),
		...
		function ep(e, t, n, r, _i, a, o, s, c, l, u, d) {
			return (
	...
	S = (e, t) => {
		const n = (0, b.forwardRef)(({ className: n, ...r }, i) =>
			(0, b.createElement)(x, {
				ref: i,
				iconNode: t,
				className: v(`lucide-${_(e)}`, n),
				...r,
			}),
		);
	...
	w = S(`Check`, [[`path`, { d: `M20 6 9 17l-5-5`, key: `1gmf2c` }]]),
	T = S(`Moon`, [
...
var D = (e) => (typeof e === `boolean` ? `${e}` : e === 0 ? `0` : e),
	O = ce,
	le = (e, t) => (n) => {
...
var A = o((e) => {
		...
		function r(e, n, r) {
			var i = null;
			if ((r !== void 0 && (i = ``), n.key !== void 0 && (i = ``), `key` in n))
...
function fe(e) {
	const t = pe(e),
		n = b.forwardRef((e, n) => {
			...
			return (0, j.jsx)(t, { ...i, ref: n, children: r });
		});
	...
	const t = b.forwardRef((e, t) => {
		...
		if (b.isValidElement(n)) {
			const e = _e(n),
				i = ge(r, n.props);
			return (
				n.type !== b.Fragment && (i.ref = t ? de(t, e) : e),
				b.cloneElement(n, i)
			);
		}
...
function ye(e, t = []) {
	let n = [];
	function r(t, r) {
		const i = b.createContext(r),
			a = n.length;
		n = [...n, r];
		const o = (t) => {
			const { scope: n, children: r, ...o } = t,
				s = n?.[e]?.[a] || i,
				c = b.useMemo(() => o, Object.values(o));
	...
	const i = () => {
		...
		return (n) => {
			const r = n?.[e] || t;
			return b.useMemo(() => ({ [`__scope${e}`]: { ...n, [e]: r } }), [n, r]);
		};
	};
...
function be(...e) {
	...
	const n = () => {
		...
		return (e) => {
			const r = n.reduce((t, { useScope: n, scopeName: r }) => {
				const i = n(e)[`__scope${r}`];
				return { ...t, ...i };
			}, {});
...
function xe(e) {
	...
	const s = `${e}CollectionSlot`,
		...
		l = b.forwardRef((e, t) => {
			...
			return (0, j.jsx)(c, { ref: k(t, a(s, n).collectionRef), children: r });
		});
	l.displayName = s;
...
var Ce = globalThis?.document ? b.useLayoutEffect : () => {},
	we = b.useInsertionEffect || Ce;
function Te({ prop: e, defaultProp: t, onChange: n = () => {}, caller: r }) {
	const [i, a, o] = Ee({ defaultProp: t, onChange: n }),
		s = e !== void 0,
		c = s ? e : i;
	{
		const t = b.useRef(e !== void 0);
		b.useEffect(() => {
			const e = t.current;
			e !== s &&
				console.warn(
...
function Ee({ defaultProp: e, onChange: t }) {
		...
		Ce(() => {
			if (t) {
				let e,
					...
					o = (a) => {
						const o = je(r.current).includes(CSS.escape(a.animationName));
					...
					c = (e) => {
						e.target === t && (a.current = je(r.current));
					};
				return (
...
var Ne = b.useId || (() => void 0),
	Pe = 0;
function Fe(e) {
	const [t, n] = b.useState(Ne());
	return (
		Ce(() => {
			e || n((e) => e ?? String(Pe++));
		}, [e]),
...
var Ie = b.createContext(void 0);
function Le(e) {
	const t = b.useContext(Ie);
	return e || t || `ltr`;
}
function Re(e) {
	const t = b.useRef(e);
...
var Ve = `rovingFocusGroup.onEntryFocus`,
	...
	Ze = b.forwardRef((e, t) =>
		(0, j.jsx)(We.Provider, {
			...
			children: (0, j.jsx)(We.Slot, {
				scope: e.__scopeRovingFocusGroup,
				children: (0, j.jsx)(Qe, { ...e, ref: t }),
			}),
		}),
	);
Ze.displayName = Ue;
var Qe = b.forwardRef((e, t) => {
		const {
			...
			p = k(t, f),
			m = Le(a),
			[h, g] = Te({ prop: o, defaultProp: s ?? null, onChange: c, caller: Ue }),
			[_, v] = b.useState(!1),
			y = Re(l),
			x = Ge(n),
			S = b.useRef(!1),
		...
		return (
			b.useEffect(() => {
				const e = f.current;
				if (e)
					return e.addEventListener(Ve, y), () => e.removeEventListener(Ve, y);
			}, [y]),
			(0, j.jsx)(Ye, {
				scope: n,
				orientation: r,
				...
				loop: i,
				currentTabStopId: h,
				onItemFocus: b.useCallback((e) => g(e), [g]),
				onItemShiftTab: b.useCallback(() => v(!0), []),
				onFocusableItemAdd: b.useCallback(() => w((e) => e + 1), []),
				onFocusableItemRemove: b.useCallback(() => w((e) => e - 1), []),
				children: (0, j.jsx)(ve.div, {
					tabIndex: _ || C === 0 ? -1 : 0,
					"data-orientation": r,
					...d,
					ref: p,
					...
					onFocus: Se(e.onFocus, (e) => {
						const t = !S.current;
						if (e.target === e.currentTarget && t && !_) {
							const t = new CustomEvent(Ve, He);
	...
	et = b.forwardRef((e, t) => {
		...
		return (
			...
			(0, j.jsx)(We.ItemSlot, {
				...
				focusable: r,
				active: i,
				children: (0, j.jsx)(ve.span, {
					tabIndex: d ? 0 : -1,
					"data-orientation": u.orientation,
					...s,
					ref: t,
					onMouseDown: Se(e.onMouseDown, (e) => {
						r ? u.onItemFocus(l) : e.preventDefault();
					}),
					onFocus: Se(e.onFocus, () => u.onItemFocus(l)),
					onKeyDown: Se(e.onKeyDown, (e) => {
						if (e.key === `Tab` && e.shiftKey) {
							u.onItemShiftTab();
							return;
						}
						if (e.target !== e.currentTarget) return;
						const t = rt(e, u.orientation, u.dir);
						if (t !== void 0) {
...
function at(e, t) {
	return e.map((_n, r) => e[(t + r) % e.length]);
}
var ot = Ze,
	st = et;
function ct(e, [t, n]) {
...
var lt = [`PageUp`, `PageDown`],
	ut = [`ArrowUp`, `ArrowDown`, `ArrowLeft`, `ArrowRight`],
	dt = {
	...
	yt = b.forwardRef((e, t) => {
		...
		function T() {
			const e = S.current[_.current];
			y[_.current] !== e && f(y);
		}
		function ee(e, t, { commit: n } = { commit: !1 }) {
			const o = Ht(a),
				s = ct(Ut(Math.round((e - r) / a) * a + r, o), [r, i]);
			x((e = []) => {
				const r = Pt(e, s, t);
				if (Bt(r, c * a)) {
		...
		return (0, j.jsx)(_t, {
			...
			orientation: o,
			form: m,
			children: (0, j.jsx)(ft.Provider, {
				scope: e.__scopeSlider,
				children: (0, j.jsx)(ft.Slot, {
					scope: e.__scopeSlider,
					children: (0, j.jsx)(v, {
						"aria-disabled": s,
						...
						...h,
						ref: t,
						onPointerDown: Se(h.onPointerDown, () => {
							s || (S.current = y);
						}),
						min: r,
						max: i,
						...
						onHomeKeyDown: () => !s && ee(r, 0, { commit: !0 }),
						onEndKeyDown: () => !s && ee(i, y.length - 1, { commit: !0 }),
						onStepKeyDown: ({ event: e, direction: t }) => {
							if (!s) {
								const n =
										lt.includes(e.key) || (e.shiftKey && ut.includes(e.key))
											? 10
											: 1,
									r = _.current,
									i = y[r];
								ee(i + a * n * t, r, { commit: !0 });
							}
						},
					}),
				}),
...
var [bt, xt] = ht(N, {
	...
	St = b.forwardRef((e, t) => {
		const {
			...
			_ = (g && !a) || (!g && a);
		function v(e) {
			const t = m.current || d.getBoundingClientRect(),
				i = Vt([0, t.width], _ ? [n, r] : [r, n]);
		...
		return (0, j.jsx)(bt, {
			...
			children: (0, j.jsx)(wt, {
				...
				onStepKeyDown: (e) => {
					const t = dt[_ ? `from-left` : `from-right`].includes(e.key);
	...
	Ct = b.forwardRef((e, t) => {
		...
		return (0, j.jsx)(bt, {
			...
			children: (0, j.jsx)(wt, {
				...
				onStepKeyDown: (e) => {
					const t = dt[p ? `from-bottom` : `from-top`].includes(e.key);
	...
	wt = b.forwardRef((e, t) => {
		...
		return (0, j.jsx)(ve.span, {
			...
			onKeyDown: Se(e.onKeyDown, (e) => {
				e.key === `Home`
					...
					: e.key === `End`
						...
						: lt.concat(ut).includes(e.key) && (c(e), e.preventDefault());
			}),
			onPointerDown: Se(e.onPointerDown, (e) => {
				const t = e.target;
			...
			onPointerUp: Se(e.onPointerUp, (e) => {
				const t = e.target;
...
var Dt = `SliderRange`,
	Ot = b.forwardRef((e, t) => {
		const { __scopeSlider: n, ...r } = e,
			...
			o = k(t, b.useRef(null)),
			s = i.values.length,
			c = i.values.map((e) => Ft(e, i.min, i.max)),
			l = s > 1 ? Math.min(...c) : 0,
			u = 100 - Math.max(...c);
		return (0, j.jsx)(ve.span, {
			"data-orientation": i.orientation,
...
var kt = `SliderThumb`,
	At = b.forwardRef((e, t) => {
		...
		return (0, j.jsx)(jt, { ...e, ref: a, index: o });
	}),
	jt = b.forwardRef((e, t) => {
		const { __scopeSlider: n, index: r, name: i, ...a } = e,
			o = vt(kt, n),
			s = xt(kt, n),
			[c, l] = b.useState(null),
			u = k(t, (e) => l(e)),
			d = c ? o.form || !!c.closest(`form`) : !0,
			f = Be(c),
			p = o.values[r],
			m = p === void 0 ? 0 : Ft(p, o.min, o.max),
			h = It(r, o.values.length),
			g = f?.[s.size],
			_ = g ? Rt(g, m, s.direction) : 0;
		return (
			b.useEffect(() => {
				if (c)
					return (
...
At.displayName = kt;
var Mt = `RadioBubbleInput`,
	Nt = b.forwardRef(({ __scopeSlider: e, value: t, ...n }, r) => {
...
var Wt = yt,
	...
	$t = b.forwardRef((e, t) => {
		const {
			...
			m = k(t, (e) => p(e)),
			h = b.useRef(!1),
			g = f ? u || !!f.closest(`form`) : !0,
			[_, v] = Te({ prop: i, defaultProp: a ?? !1, onChange: l, caller: Jt });
		return (0, j.jsxs)(Zt, {
			scope: n,
			checked: _,
			disabled: s,
...
tn.displayName = en;
var nn = `SwitchBubbleInput`,
	rn = b.forwardRef(
		(
			{ __scopeSwitch: e, control: t, checked: n, bubbles: r = !0, ...i },
			a,
		) => {
...
var on = $t,
	...
	mn = b.forwardRef((e, t) => {
		const {
			...
			u = Le(s),
			[d, f] = Te({ prop: r, onChange: i, defaultProp: a ?? ``, caller: cn });
		return (0, j.jsx)(fn, {
			scope: n,
			baseId: Fe(),
			value: d,
	...
	vn = b.forwardRef((e, t) => {
		...
		return (0, j.jsx)(st, {
			...
			children: (0, j.jsx)(ve.button, {
				...
				onFocus: Se(e.onFocus, () => {
					const e = o.activationMode !== `manual`;
...
var yn = `TabsContent`,
	bn = b.forwardRef((e, t) => {
		const { __scopeTabs: n, value: r, forceMount: i, children: a, ...o } = e,
			s = pn(yn, n),
			c = xn(s.baseId, r),
			l = Sn(s.baseId, r),
			u = r === s.value,
		...
		return (
			b.useEffect(() => {
				const e = requestAnimationFrame(() => (d.current = !1));
...
var Cn = mn,
	...
	Tn = vn,
	En = (e, t) => {
		const n = Array(e.length + t.length);
		for (let t = 0; t < e.length; t++) n[t] = e[t];
		for (let r = 0; r < t.length; r++) n[e.length + r] = t[r];
		return n;
	},
	Dn = (e, t) => ({ classGroupId: e, validator: t }),
	On = (e = new Map(), t = null, n) => ({
		nextPart: e,
		validators: t,
		classGroupId: n,
	}),
	...
	Nn = (e, t, n) => {
		...
		if (a === null) return;
		const o = t === 0 ? e.join(kn) : e.slice(t).join(kn),
			s = a.length;
		for (let e = 0; e < s; e++) {
			const t = a[e];
	...
	Un = (e) => `isThemeGetter` in e && e.isThemeGetter === !0,
	Wn = (e) => {
	...
	Yn = (e) => {
		let { prefix: t, experimentalParseClassName: n } = e,
			r = (e) => {
				...
				s.endsWith(Gn)
					? ((c = s.slice(0, -1)), (l = !0))
					: s.startsWith(Gn) && ((c = s.slice(1)), (l = !0));
				const u = a && a > i ? a - i : void 0;
				return Jn(t, l, c, u);
			};
		if (t) {
			const e = t + Kn,
				n = r;
			r = (t) =>
				t.startsWith(e) ? n(t.slice(e.length)) : Jn(qn, !1, t, void 0, !0);
		}
		if (n) {
			const e = r;
	...
	er = (e, t) => {
		...
		for (let e = c.length - 1; e >= 0; --e) {
			...
			const _ = d.length === 0 ? `` : d.length === 1 ? d[0] : a(d).join(`:`),
				v = f ? _ + Gn : _,
				y = v + g;
	...
	hr = (e) => e.endsWith(`%`) && F(e.slice(0, -1)),
	gr = (e) => cr.test(e),
	_r = () => !0,
	vr = (e) => lr.test(e) && !ur.test(e),
	yr = () => !1,
	br = (e) => dr.test(e),
	xr = (e) => fr.test(e),
	Sr = (e) => !I(e) && !L(e),
	...
	Yr = rr(() => {
		const e = P(`color`),
			...
			w = () => [L, I, c],
			T = () => [pr, `full`, `auto`, ...w()],
			ee = () => [mr, `none`, `subgrid`, L, I],
			te = () => [`auto`, { span: [`full`, mr, L, I] }, mr, L, I],
			E = () => [mr, `auto`, L, I],
			ne = () => [`auto`, `min`, `max`, `fr`, L, I],
			re = () => [
				`start`,
				`end`,
				`center`,
			...
			D = () => [e, L, I],
			O = () => [...b(), Pr, kr, { position: [L, I] }],
			le = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
			ue = () => [`auto`, `cover`, `contain`, Fr, wr, { size: [L, I] }],
			de = () => [hr, Mr, Tr],
			k = () => [``, `none`, `full`, l, L, I],
			A = () => [``, F, Mr, Tr],
		...
		return {
			...
			classGroups: {
				aspect: [{ aspect: [`auto`, `square`, pr, I, L, g] }],
				container: [`container`],
				"container-type": [{ "@container": [``, `normal`, `size`, L, I] }],
				"container-named": [Cr],
				columns: [{ columns: [F, I, L, s] }],
				...
				z: [{ z: [mr, `auto`, L, I] }],
				basis: [{ basis: [pr, `full`, `auto`, s, ...w()] }],
				"flex-direction": [
					{ flex: [`row`, `row-reverse`, `col`, `col-reverse`] },
				],
				"flex-wrap": [{ flex: [`nowrap`, `wrap`, `wrap-reverse`] }],
				flex: [{ flex: [F, pr, `auto`, `initial`, `none`, I] }],
				grow: [{ grow: [``, F, L, I] }],
				shrink: [{ shrink: [``, F, L, I] }],
				order: [{ order: [mr, `first`, `last`, `none`, L, I] }],
				...
				w: [{ w: [s, `screen`, ...oe()] }],
				"min-w": [{ "min-w": [s, `screen`, `none`, ...oe()] }],
				"max-w": [
					{ "max-w": [s, `screen`, `none`, `prose`, { screen: [o] }, ...oe()] },
				],
				h: [{ h: [`screen`, `lh`, ...oe()] }],
				"min-h": [{ "min-h": [`screen`, `lh`, `none`, ...oe()] }],
				"max-h": [{ "max-h": [`screen`, `lh`, ...oe()] }],
				"font-size": [{ text: [`base`, n, Mr, Tr] }],
				"font-smoothing": [`antialiased`, `subpixel-antialiased`],
				"font-style": [`italic`, `not-italic`],
				"font-weight": [{ font: [r, Rr, Dr] }],
				"font-stretch": [
					{
						"font-stretch": [
							`ultra-condensed`,
				...
				"line-clamp": [{ "line-clamp": [F, `none`, L, Er] }],
				leading: [{ leading: [a, ...w()] }],
				...
				"text-decoration-thickness": [
					{ decoration: [F, `from-font`, `auto`, L, Tr] },
				],
				...
				"drop-shadow": [{ "drop-shadow": [``, `none`, p, Lr, jr] }],
...
function Xr({ className: e, orientation: t = `horizontal`, ...n }) {
	return (0, j.jsx)(Cn, {
		"data-slot": `tabs`,
		"data-orientation": t,
		className: R(`group/tabs flex gap-2 data-horizontal:flex-col`, e),
		...n,
	});
}
var Zr = le(
...
function ti({
	...
	return (0, j.jsx)(r ? M : `button`, {
		"data-slot": `button`,
		"data-variant": t,
		"data-size": n,
		className: R(ei({ variant: t, size: n, className: e })),
		...i,
	});
}
function ni() {
	...
	return (
		...
		}, [e]),
		{
			...
			toggle: (0, b.useCallback)(() => {
				t((e) => {
					const t = !e;
					return localStorage.setItem(`theme`, t ? `dark` : `light`), t;
				});
			}, []),
		}
	);
}
function ai({ children: e, currentTab: t, setTab: n, connected: r }) {
	const { isDark: i, toggle: a } = ii();
	return (0, j.jsxs)(`div`, {
				...
				children: (0, j.jsxs)(`div`, {
					...
					children: [
						(0, j.jsxs)(`div`, {
							...
							children: [
								(0, j.jsx)(`h1`, {
									className: `text-xl font-heading font-semibold tracking-wider uppercase`,
									children: `IoT Monitor`,
								}),
								(0, j.jsx)(`span`, {
									className: `inline-block size-3 rounded-full ${r ? `bg-green-400` : `bg-red-400`}`,
									title: r ? `Conectado` : `Desconectado`,
								}),
							],
						}),
						(0, j.jsxs)(`div`, {
							...
							children: [
								(0, j.jsx)(ti, {
									...
									size: `icon-sm`,
									onClick: a,
									title: i ? `Modo claro` : `Modo escuro`,
									className: `text-primary-foreground hover:text-primary-foreground/80`,
									children: i
										? (0, j.jsx)(ie, { className: `size-4` })
										: (0, j.jsx)(T, { className: `size-4` }),
								}),
								(0, j.jsx)(Xr, {
									value: t,
									onValueChange: n,
									children: (0, j.jsxs)(Qr, {
										variant: `line`,
										className: `[&>button]:text-primary-foreground/70 [&>button]:data-active:text-primary-foreground`,
										children: [
											(0, j.jsxs)($r, {
												value: `dashboard`,
												children: [
													(0, j.jsx)(C, { className: `size-4` }),
													`Dashboard`,
												],
											}),
											(0, j.jsxs)($r, {
												value: `config`,
												children: [
													(0, j.jsx)(re, { className: `size-4` }),
													`Config`,
												],
											}),
											(0, j.jsx)($r, { value: `console`, children: `Console` }),
										],
									}),
								}),
							],
...
function oi({ className: e, size: t = `default`, ...n }) {
	return (0, j.jsx)(`div`, {
		"data-slot": `card`,
		"data-size": t,
		className: R(
...
function li({ className: e, ...t }) {
	return (0, j.jsx)(`div`, {
		...
		className: R(`px-8 group-data-[size=sm]/card:px-5`, e),
		...t,
	});
}
var ui = le(
...
function di({ className: e, variant: t = `default`, asChild: n = !1, ...r }) {
	return (0, j.jsx)(n ? M : `span`, {
		"data-slot": `badge`,
		"data-variant": t,
		className: R(ui({ variant: t }), e),
		...r,
	});
}
function fi({ className: e, size: t = `default`, ...n }) {
	return (0, j.jsx)(on, {
		"data-slot": `switch`,
		"data-size": t,
		className: R(
...
function pi({
	...
	return (0, j.jsxs)(Wt, {
		...
		children: [
			...
			Array.from({ length: o.length }, (_e, t) =>
				(0, j.jsx)(
					qt,
					{
...
function bi(e) {
	const t = xi(e),
		n = b.forwardRef((e, n) => {
			let { children: r, ...i } = e;
			yi(r) && typeof _i === `function` && (r = _i(r._payload));
			const a = b.Children.toArray(r),
				o = a.find(Ci);
			if (o) {
				const e = o.props.children,
					r = a.map((t) =>
...
function xi(e) {
	const t = b.forwardRef((e, t) => {
		let { children: n, ...r } = e;
		if (
			(yi(n) && typeof _i === `function` && (n = _i(n._payload)),
			b.isValidElement(n))
		) {
			const e = Ti(n),
				i = wi(r, n.props);
...
var Ei = [
	...
	Ni = b.forwardRef((e, t) => {
		...
		(i || i === 0) && !Li(i) && console.error(zi(`${i}`, `Progress`));
		const s = Li(i) ? i : Oi;
		r !== null && !Ri(r, s) && console.error(Bi(`${r}`, `Progress`));
		const c = Ri(r, s) ? r : null,
			l = Ii(c) ? a(c, s) : void 0;
		return (0, j.jsx)(ji, {
			scope: n,
			value: c,
			max: s,
			children: (0, j.jsx)(Ei.div, {
				"aria-valuemax": s,
				"aria-valuemin": 0,
				"aria-valuenow": Ii(c) ? c : void 0,
				"aria-valuetext": l,
				role: `progressbar`,
				"data-state": Fi(c, s),
				"data-value": c ?? void 0,
...
Ni.displayName = Di;
var z = `ProgressIndicator`,
	B = b.forwardRef((e, t) => {
		const { __scopeProgress: n, ...r } = e,
			i = Mi(z, n);
		return (0, j.jsx)(Ei.div, {
			"data-state": Fi(i.value, i.max),
...
function Li(e) {
	return Ii(e) && !Number.isNaN(e) && e > 0;
}
function Ri(e, t) {
	return Ii(e) && !Number.isNaN(e) && e <= t && e >= 0;
}
function zi(e, t) {
	return `Invalid prop \`max\` of value \`${e}\` supplied to \`${t}\`. Only numbers greater than 0 are valid max values. Defaulting to \`${Oi}\`.`;
}
function Bi(e, t) {
...
var Vi = Ni,
	Hi = B;
function Ui({ className: e, value: t, ...n }) {
	return (0, j.jsx)(Vi, {
		"data-slot": `progress`,
		className: R(
...
function Wi({ className: e, type: t, ...n }) {
...
function Gi(e) {
	...
	const t = {
		...
		i = e
			...
			.split(`_`)
			.filter((e) => e && !/^\d+$/.test(e));
	if (i.includes(`sensor`) || i[0] === `sensor`) {
		const e =
				i
					.filter((e) => t[e])
					.map((e) => t[e])
			...
			n =
				i
					...
					.map((e) => r[e])
					.join(` e `) || ``;
		if (e && n) return `Sensor de ${n} — ${e}`;
		if (n) return `Sensor de ${n}`;
	}
	const a =
			i
				.filter((e) => t[e])
	...
	return a && o
		? `${o} — ${a}`
		: a || o || i.map((e) => e.charAt(0).toUpperCase() + e.slice(1)).join(` `);
}
function Ki(e, t, n) {
...
function Ji(e, t, n, r) {
	return n?.[e]?.[t]?.trim() || r?.[t]?.trim() || void 0;
}
function Yi(e) {
	return e.includes(`_light_`);
}
function Xi(e) {
	return e.startsWith(`sensor_`);
}
var Zi = `matriz-gui:device-aliases`;
function Qi() {
	if (typeof window > `u`) return {};
	try {
		const e = window.localStorage.getItem(Zi);
		if (!e) return {};
...
function $i() {
	const [e, t] = (0, b.useState)(() => Qi()),
		n = (0, b.useCallback)((e) => {
			t(e),
				typeof window < `u` &&
					window.localStorage.setItem(Zi, JSON.stringify(e));
		}, []),
		r = (0, b.useCallback)((t, n) => e[qi(t, n)], [e]),
		i = (0, b.useCallback)(
			(t, r, i) => {
				const a = qi(t, r),
					o = i.trim(),
					s = { ...e };
				o ? (s[a] = o) : delete s[a], n(s);
			},
			[e, n],
		),
		a = (0, b.useCallback)(
	...
	return (0, b.useMemo)(
		() => ({ getAlias: r, setAlias: i, clearAlias: a, aliases: e }),
		[r, i, a, e],
	);
}
function ea({ filiais: e, config: t, onCommand: n }) {
	const r = Object.values(e),
		{ getAlias: i, setAlias: a, clearAlias: o } = $i(),
	...
	return r.length === 0
		? (0, j.jsx)(`div`, {
				...
				children: `Aguardando dados das filiais...`,
			})
		: (0, j.jsx)(`div`, {
				className: `grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6`,
				children: r.map((e) => {
					const r = Date.now() - e.lastSeen > 15e3;
					return (0, j.jsxs)(
						oi,
						{
							size: `sm`,
							className: `border-0 shadow-md ${r ? `opacity-70` : ``}`,
							children: [
								(0, j.jsx)(si, {
									children: (0, j.jsxs)(`div`, {
										...
										children: [
											...
											(0, j.jsx)(di, {
												variant: r ? `destructive` : `outline`,
												children: r ? `Offline` : `Online`,
											}),
										],
									}),
								}),
										...
										children: [
											e.devices.length === 0 &&
												(0, j.jsx)(`div`, {
													...
													children: `Sem dispositivos reportados ainda.`,
												}),
											e.devices.map((r) => {
												const a = Yi(r),
													c = Xi(r),
													m = c && (r.includes(`light`) || r.includes(`lux`)),
													h = e.state[r],
													g = Number(h || 0),
													_ = `${e.ip}::${r}`,
													v = Ki(
														r,
														i(e.ip, r),
														Ji(e.ip, r, t?.deviceAliasesByIp, t?.deviceAliases),
													),
													y = s === _;
												return (0, j.jsxs)(
													`div`,
													{
														...
														children: [
															...
															m
																? (0, j.jsxs)(`div`, {
																		className: `flex items-center justify-between gap-3 rounded-xl border bg-amber-50/70 px-3 py-2 dark:bg-amber-950/20`,
																		children: [
																			(0, j.jsxs)(`div`, {
																				className: `flex items-center gap-2`,
																				children: [
																					(0, j.jsx)(`div`, {
																						className: `h-2.5 w-2.5 rounded-full ${g > 0 ? `bg-emerald-500` : `bg-zinc-400`}`,
																					}),
																					(0, j.jsxs)(`span`, {
																						className: `inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs font-semibold ${g > 0 ? `bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300` : `bg-zinc-200 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300`}`,
																						children: [
																							g > 0
																								? (0, j.jsx)(E, {
																										className: `h-3 w-3`,
																	...
																	: c
																		? (0, j.jsxs)(`div`, {
																				...
																				children: [
																					...
																					(0, j.jsx)(`span`, {
																						className: `text-xs font-mono text-muted-foreground w-12 text-right tabular-nums`,
																						children: h ?? 0,
																					}),
																				],
																			})
...
function na() {
	...
	const c = async () => {
			if (e) {
				...
				try {
					(
						await fetch(`${ta}/api/config`, {
							method: `PUT`,
							body: JSON.stringify(e),
							headers: { "Content-Type": `application/json` },
						})
					).ok
						? s(`Configuracao salva com sucesso!`)
						: s(`Erro ao salvar configuracao.`);
				} catch {
					s(`Erro de conexao ao salvar.`);
				}
				a(!1);
			}
		},
		l = (n, r, i) => {
			if (!e) return;
			const a = [...e.filiais];
			(a[n] = { ...a[n], [r]: i }), t({ ...e, filiais: a });
		},
		u = (n) => {
			e && t({ ...e, filiais: e.filiais.filter((_e, t) => t !== n) });
		};
	return n
		? (0, j.jsx)(`div`, {
		...
		: e
			? (0, j.jsxs)(oi, {
					...
					children: [
						(0, j.jsx)(si, {
							children: (0, j.jsx)(ci, { children: `Configuracoes da Matriz` }),
						}),
						(0, j.jsxs)(li, {
							...
							children: [
										...
										(0, j.jsxs)(`div`, {
											children: [
												...
												(0, j.jsx)(Wi, {
													type: `text`,
													value: e.user,
													onChange: (n) => t({ ...e, user: n.target.value }),
												}),
											],
										}),
										(0, j.jsxs)(`div`, {
											children: [
												...
												(0, j.jsx)(Wi, {
													type: `password`,
													value: e.pass,
													onChange: (n) => t({ ...e, pass: n.target.value }),
												}),
											],
										}),
										(0, j.jsxs)(`div`, {
											children: [
												...
												(0, j.jsx)(Wi, {
													...
													onChange: (n) =>
														t({
															...e,
															pollingMs: parseInt(n.target.value, 10) || 0,
														}),
												}),
											],
										}),
								...
								(0, j.jsxs)(`div`, {
									children: [
										(0, j.jsx)(`h3`, {
											className: `font-heading font-semibold mb-3 tracking-wider uppercase text-sm`,
											children: `Filiais Cadastradas`,
										}),
										(0, j.jsx)(`div`, {
											className: `flex flex-col gap-3 mb-6`,
											children: e.filiais.map((e, t) =>
												(0, j.jsxs)(
													`div`,
													{
														...
														children: [
															...
															(0, j.jsx)(Wi, {
																...
																value: e.ip,
																onChange: (e) => l(t, `ip`, e.target.value),
																placeholder: `IP`,
															}),
															(0, j.jsx)(Wi, {
																type: `number`,
											...
											onClick: () => {
												e &&
													t({
														...
														filiais: [
															...e.filiais,
															{ name: `Nova Filial`, ip: ``, port: 51e3 },
														],
													});
											},
											children: `+ Adicionar Filial`,
										}),
										(0, j.jsx)(ti, {
											onClick: c,
											disabled: i,
											className: `ml-auto`,
											children: i ? `Salvando...` : `Salvar Configuracoes`,
										}),
										o &&
											(0, j.jsx)(di, {
												variant: o.includes(`sucesso`)
													? `outline`
													: `destructive`,
												className: `ml-2`,
												children: o,
			...
			: (0, j.jsx)(`div`, {
					...
					children: `Falha ao carregar configuracoes.`,
				});
}
function ra({ logs: e, onClear: t }) {
	...
	return (
		(0, b.useEffect)(() => {
			const e = r.current;
			e && (i.current = e.scrollHeight - e.scrollTop - e.clientHeight < 50);
		}, [e]),
		(0, b.useEffect)(() => {
			i.current && n.current?.scrollIntoView({ behavior: `smooth` });
		}, [e]),
		(0, j.jsxs)(`div`, {
			className: `space-y-2`,
			children: [
					...
					children: [
						...
						e.map((e, t) =>
							(0, j.jsxs)(
								...
								{
									className:
										e.level === `error` ? `text-red-400` : `text-green-400`,
									children: [
										(0, j.jsxs)(`span`, {
...
var ia = `ws://localhost:3001/ws`,
	aa = `http://localhost:3001`;
function oa() {
	const [e, t] = (0, b.useState)({}),
		...
		u = (0, b.useRef)(1e3),
		d = (0, b.useCallback)(() => {
			if (c.current?.readyState === WebSocket.OPEN) return;
			const e = new WebSocket(ia);
			(c.current = e),
				(e.onopen = () => {
					r(!0),
						(u.current = 1e3),
				...
				(e.onclose = () => {
					r(!1), (c.current = null);
					const e = u.current;
					(u.current = Math.min(u.current * 2, 3e4)),
						(l.current = setTimeout(d, e));
				}),
				(e.onmessage = (e) => {
					try {
						...
						if (n.type === `ws_rx`) {
							...
							t((t) => {
								let n = t[e] || {
										ip: e,
										name: i?.filiais.find((t) => t.ip === e)?.name || e,
										devices: [],
										state: {},
										lastSeen: 0,
									},
									...
									o = [...n.devices];
								return (
									r.cmd === `list_resp` && Array.isArray(r.id)
										? (o = r.id)
										: (r.cmd === `get_resp` || r.cmd === `set_resp`) &&
											...
											r.id && r.value !== void 0 && (a[r.id] = r.value)),
									{
										...t,
										[e]: { ...n, devices: o, state: a, lastSeen: Date.now() },
									}
								);
							});
						} else
							n.type === `log` &&
								s((e) => {
									const t = [
										...e,
										{ level: n.level, message: n.message, ts: n.ts },
									];
									return t.length > 500 ? t.slice(t.length - 500) : t;
								});
					} catch (e) {
	...
	(0, b.useEffect)(
		() => (
			d(),
			() => {
				l.current && clearTimeout(l.current), c.current?.close();
			}
		),
		[d],
	);
	const f = (0, b.useCallback)((e) => {
			t((t) => {
				const n = { ...t };
				for (const t of e.filiais)
					n[t.ip] && (n[t.ip] = { ...n[t.ip], name: t.name });
				return n;
			});
		}, []),
		p = (0, b.useCallback)(async () => {
			try {
				const e = await (await fetch(`${aa}/api/config`)).json();
				a(e), f(e);
			} catch {
	...
	return (
		...
		}, [p]),
		{
			...
			config: i,
			logs: o,
			updateConfig: (0, b.useCallback)(
				async (e) => {
					try {
						await fetch(`${aa}/api/config`, {
							method: `PUT`,
							body: JSON.stringify(e),
							headers: { "Content-Type": `application/json` },
						}),
			...
			sendCommand: (0, b.useCallback)((e, t, n) => {
				c.current &&
					c.current.readyState === WebSocket.OPEN &&
					c.current.send(
						JSON.stringify({
							type: `ws_tx`,
							target_ip: e,
							payload: { cmd: `set_req`, id: t, value: n },
						}),
					);
			}, []),
			clearLogs: () => s([]),
...
function ca({ className: e, variant: t, ...n }) {
	return (0, j.jsx)(`div`, {
		"data-slot": `alert`,
		role: `alert`,
		className: R(sa({ variant: t }), e),
		...n,
	});
}
...
function ua() {
	const [e, t] = (0, b.useState)(`dashboard`),
		{
			filiais: n,
			config: r,
			connected: i,
		...
		children: [
			!i &&
				(0, j.jsx)(ca, {
					...
					className: `mb-4`,
					children: (0, j.jsx)(la, {
						children: `Desconectado da Matriz. Tentando reconectar...`,
					}),
				}),
			e === `dashboard` &&
				(0, j.jsx)(ea, { filiais: n, config: r, onCommand: o }),
			e === `config` && (0, j.jsx)(na, {}),
			e === `console` && (0, j.jsx)(ra, { logs: a, onClear: s }),
		],
	});
}
(0, oe.createRoot)(document.getElementById(`root`)).render(
	(0, j.jsx)(b.StrictMode, { children: (0, j.jsx)(ua, {}) }),
);
